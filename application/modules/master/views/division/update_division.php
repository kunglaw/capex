    ...
    <div class="modal-content animated bounceInRight">
            ...
            <form class="form" id="update-division-form" onSubmit="">
              ...
              <div class="modal-body">
              	  <div class="result-divisi-update"></div>
                  <div class="form-group">
                  	<label>Kode Divisi</label>
                    <input type="text" value="<?=$division["kode_div"]?>" class="form-control" name="kode_divisi" id="kode_divisi" readonly>
                  </div>
                  <div class="form-group">
                  	<label> Divisi </label>
	...
	$("form#update-division-form").submit(function(){
		...
		$.ajax({
			...
			success: function(dt)
			{
				...
				$(".result-divisi-update").html(dt.message);
