...
<div class="modal inmodal" id="update-transfer-modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                
                <h4 class="modal-title">Update Transfer Detail Opex</h4>
                
            </div>
            <form class="form" id="update-transfer-form" onSubmit="">
             	<input type="hidden" name="trf_tr_id" id="trf_tr_id" 
                value="<?=$transfer["trf_tr_id"]?>">
...
<script>
	...
	$("form#update-transfer-form").submit(function(){
		
		$.ajax({
			
			type:"POST",
			dataType:"json",
			data:$("#update-transfer-form").serialize(),
			
			url:"<?=base_url("opex/transfer/update_transfer_process")?>",
			success: function(dt)
			{
