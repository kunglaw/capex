<div class="modal inmodal" id="confirm-delete" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content animated bounceInRight">
            ...
            <form class="form" id="delete-transfer-form">
              <div class="modal-body">
              	
              	<div class="result-confirm-delete"></div>
              	Are you sure want to delete this Transfer <b>"<?=$opex_trd["no_acc_opex"]?>"</b> on year <b><?=$opex_trd["year"]?></b> ? 
...
<script>
	...
	$("form#delete-transfer-form").submit(function(){
		
		$.ajax({
			type:"POST",
			dataType:"JSON",
			url:"<?=base_url("opex/transfer/delete_transfer_process")?>",
			data:$(this).serialize(),
			success:function(dt)
			{
